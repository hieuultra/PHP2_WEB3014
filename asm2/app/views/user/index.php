...
<head>
    ...
    <!-- Favicon -->
    <link href="app/user/img/favicon.ico" rel="icon" />
    ...
    <link rel="stylesheet" href="app/user/css/popup.css">
</head>
...
<body>
  ...
  ';
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="app/views/user/img/s1.jpg" style="object-fit: cover;">
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="app/views/user/img/s2.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="app/views/user/img/s3.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="product-offer mb-2">
                            <img class="img-fluid w-100" src="app/views/user/img/b1.jpg" alt="">
                    ...
                    <div class="col-md-12">
                        <div class="product-offer mt-2">
                            <img class="img-fluid w-100" src="app/views/user/img/b_giay.jpg" alt="">
                            <div class="offer-text position-absolute text-center w-100">
                                <h6 class="text-white text-uppercase">Save 20%</h6>
                                <h3 class="text-white mb-3">Special Offer</h3>
                                <!-- <a href="#" class="btn btn-primary">Shop Now</a> -->
    ...
    <script src="app/views/user/mail/jqBootstrapValidation.min.js"></script>
    <script src="app/views/user/mail/contact.js"></script>

    <!-- Template Javascript -->
    <script src="app/views/user/js/main.js"></script>
    <!-- Popup -->
