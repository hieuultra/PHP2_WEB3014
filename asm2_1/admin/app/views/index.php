...
<body class="sb-nav-fixed">
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseProduct" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="product/listPro">List product</a>
                                <a class="nav-link" href="product/addPro">Add product</a>
                            </nav>
                        </div>
    ...
    <script src="./app/views/js/datatables-simple-demo.js"></script>
</body>
